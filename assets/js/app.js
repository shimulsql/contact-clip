...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  var toggler = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.admin-sidebar .sidebar-toggle');
  var sidebar = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.admin-sidebar');
  toggler.click(function () {
    sidebar.toggleClass('mini-admin-sidebar');
  }); // sidebar menu

  var menu_items = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#sidebar-menu .item');
  menu_items.each(function (index) {
    var link = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('a.title');
    var subMenu = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('ul.sub-menu');
    var subMenuWrap = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('div.sub-menu-wrap');
    var animateClass = 'animate_animated animate__tada'; // click on menu item

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).click(function (e) {
      var siblings = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings(); // reset styles to default

      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings().removeClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings().each(function (i) {
        var sibling = siblings[i];
        var subMenuWrap = jquery__WEBPACK_IMPORTED_MODULE_0___default()(sibling).find('div.sub-menu-wrap');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(subMenuWrap[0]).css('max-height', 0);
      });
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass('active');

      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).hasClass('active')) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(subMenuWrap[0]).css('max-height', jquery__WEBPACK_IMPORTED_MODULE_0___default()(subMenuWrap[0]).prop('scrollHeight') + 10 + 'px'); // animate

        jquery__WEBPACK_IMPORTED_MODULE_0___default()(subMenuWrap[0]).addClass(animateClass);
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(subMenuWrap[0]).css('max-height', 0);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(subMenuWrap[0]).removeClass(animateClass);
      }
...
/***/ "./resource/src/font-awesome/css/font-awesome.css":
/*!********************************************************!*\
  !*** ./resource/src/font-awesome/css/font-awesome.css ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcontact_clip"] = self["webpackChunkcontact_clip"] || [];
