  ...
  btnLogin.click(function (e) {
    ...
    $.ajax({
      ...
      if (res.status == 'error') {
        ...
        disRes.addClass('alert-danger').fadeIn();

        if (res.response.data != undefined) {
          var errorFileds = res.response.data;
          disRes.text(errorFileds.fields);
        } else {
          disRes.text(res.response.message);
        }

        disRes.delay(3000).fadeOut();
      }
...
/* harmony export */   "redir_login": () => (/* binding */ redir_login),
/* harmony export */   "redir_logout": () => (/* binding */ redir_logout),
/* harmony export */   "get_api_url": () => (/* binding */ get_api_url)
/* harmony export */ });
// url defines
var api_root = window.location.origin;
var redir_login = api_root + '/admin';
var redir_logout = api_root + '/login.php'; // api url call
...
$(document).ready(function () {
  ...
  menu_items.each(function (index) {
    ...
    $(this).click(function (e) {
      var siblings = $(this).siblings(); // reset styles to default
      ...
      if ($(this).hasClass('active')) {
        $(subMenuWrap[0]).css('max-height', $(subMenuWrap[0]).prop('scrollHeight') + 10 + 'px'); // animate
